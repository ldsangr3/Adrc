...
#CREACIÓN, CONFIGURACIÓN Y ASIGNACIÓN DE SUBPESTAÑAS QUE CONTIENEN LAS GRÁFICAS DE CADA VARIABLE MEDIDA EN PESTAÑA FBR1
        ...
        notebook1.add(pestaña8,text='  DO  ')
...
#CREACIÓN, CONFIGURACIÓN Y ASIGNACIÓN DE SUBPESTAÑAS QUE CONTIENEN LAS GRÁFICAS DE CADA VARIABLE MEDIDA EN PESTAÑA FBR2
        ...
        notebook2.add(pestaña14,text='  DO  ')
...
#CREACIÓN, CONFIGURACIÓN Y ASIGNACIÓN DE SUBPESTAÑAS QUE CONTIENEN LAS GRÁFICAS DE CADA VARIABLE MEDIDA EN PESTAÑA FBR3
        ...
        notebook3.add(pestaña20,text='  DO  ')
...
#######################################################################################################################
        ...
        etiqueta3=Label(pestaña1,text="Colour",font=("arial",14),bg=('white')).place(x=10,y=40)
        rcolor1=IntVar()
        ...
        etiqueta4=Label(pestaña1,text="Colour Intensity",font=("arial",12),bg=('white')).place(x=140,y=40)
...
#######################################################################################################################   
        ...
        etiqueta3=Label(pestaña2,text="Colour",font=("arial",14),bg=('white')).place(x=10,y=40)
        rcolor2=IntVar()
        ...
        etiqueta4=Label(pestaña2,text="Colour Intensity",font=("arial",12),bg=('white')).place(x=140,y=40)
...
#######################################################################################################################   
        ...
        etiqueta3=Label(pestaña3,text="Colour",font=("arial",14),bg=('white')).place(x=10,y=40)
        rcolor3=IntVar()
        ...
        etiqueta4=Label(pestaña3,text="Colour Intensity",font=("arial",12),bg=('white')).place(x=140,y=40)
...
#FIGURA TEMPERATURA1
        ...
        self.ax_1 = figure.add_subplot(111)
        self.ax_1.grid(True),self.ax_1.set_xlabel('$x$'),self.ax_1.set_ylabel('$y(x)$')
...
#FIGURA pH1
        ...
        self.ax3_1.grid(True),self.ax3_1.set_xlabel('$x$'),self.ax3_1.set_ylabel('$y(x)$')
        
        self.ax3_1.set_ylim([0, 14])
...
#FIGURA DO1
        ...
        self.ax4_1 = figure4.add_subplot(111)
        self.ax4_1.grid(True),self.ax4_1.set_xlabel('$x$'),self.ax4_1.set_ylabel('$y(x)$')
        self.ax4_1.set_ylim([0, 100])
...
#MÉTODO FBR1        
    ...
    #LUZ 1
            ...
            #self.luz_real1 = (100 * round(self.valor_luz1,3)) #CALIBRACIÓN Y AJUSTE DEL SENSOR
            self.valor_luz1 = (tarjeta1.readValue('AIN3')-2.5)/51 #LEER ENTRADA ANÁLOGA AIN3
    ...
    #TEMPERATURA 1
            ...
            self.ax_1.set_xlabel('$x$'),self.ax_1.set_ylabel('$y(x)$')
            self.ax_1.clear()
...
#MÉTODO FBR2
    def fbr2(self):
        # while True:
            ...
            self.luz_real2 = (100 * round(self.valor_luz2,3))
            #self.valor_luz2 = (tarjeta1.readValue('AIN4')) #LEER ENTRADA ANÁLOGA AIN3
            #self.luz_real2 = (self.valor_luz2*100000) #CALIBRACIÓN Y AJUSTE DEL SENSOR
...
#MÉTODO FBR3
    def fbr3(self):
        # while True:
            ...
            self.luz_real3 = (100 * round(self.valor_luz3,3))
            #self.valor_luz3 = (tarjeta1.readValue('AIN5')) #LEER ENTRADA ANÁLOGA AIN3
            #self.luz_real3 = (self.valor_luz3*100000) #CALIBRACIÓN Y AJUSTE DEL SENSOR
...
##                self.line5_3.draw()
    ...
    #DO1
            ...
            self.DO_real=comunicacion.readValueI2C() #LEER SENSOR
            print('DO1',self.DO_real)
            self.ax3_1.set_xlabel('$x$'),self.ax3_1.set_ylabel('$y(x)$')
            #self.ax3_1.clear()
            self.ax3_1.set_ylim([0, 100]) # care here
            self.ax3_1.plot(self.x3,self.y3), self.ax3_1.grid(True)
            self.x3.append(datetime.now())
            self.y3.append(self.DO_real)
            self.line3.draw()
    #pH1
            ...
            self.pH_real1=comunicacion.readValueI2C()
            print('pH1',self.pH_real1)
            self.ax4_1.set_xlabel('$x$'),self.ax4_1.set_ylabel('$y(x)$')
            self.ax4_1.clear()
            self.ax4_1.set_ylim([0, 14]) # care here
            self.ax4_1.plot(self.x4,self.y4), self.ax4_1.grid(True)
            self.x4.append(datetime.now())
            self.y4.append(self.pH_real1)
            self.line4.draw()
    #DO
            comunicacion.initI2C(1, 0, 5)
            comunicacion.sendValueI2C([82])
            time.sleep(0.9)
            self.DO2_real=comunicacion.readValueI2C()
            self.ax3_2.set_xlabel('$x$'),self.ax3_2.set_ylabel('$y(x)$')
            print('DO2',self.DO2_real)
            #self.ax3_2.clear()
            self.ax3_2.set_ylim([0, 14]) # care here
            self.ax3_2.plot(self.x3_2,self.y3_2), self.ax3_2.grid(True)
            self.x3_2.append(datetime.now())
            self.y3_2.append(self.DO2_real)
            self.line3_2.draw()
    #pH
            comunicacion.initI2C(1, 0, 2)
            comunicacion.sendValueI2C([82])#114
            time.sleep(0.6)
            self.pH_real2=comunicacion.readValueI2C()
            print('pH2',self.pH_real2)
            self.ax4_2.set_xlabel('$x$'),self.ax4_2.set_ylabel('$y(x)$')
            #self.ax4_2.clear()
            self.ax4_2.set_ylim([0, 20]) # care here
            self.ax4_2.plot(self.x4_2,self.y4_2), self.ax4_2.grid(True)
            self.x4_2.append(datetime.now())
            self.y4_2.append(self.pH_real2)
            self.line4_2.draw()
    #DO3
            comunicacion.initI2C(1, 0, 4)
            comunicacion.sendValueI2C([82])
            time.sleep(0.9)
            self.DO3_real=comunicacion.readValueI2C()
            self.ax3_3.set_xlabel('$x$'),self.ax3_3.set_ylabel('$y(x)$')
            #self.ax3_3.clear()
            print('DO3',self.DO3_real)
            self.ax3_3.set_ylim([0, 14]) # care here
            self.ax3_3.plot(self.x3_3,self.y3_3), self.ax3_3.grid(True)
            self.x3_3.append(datetime.now())
            self.y3_3.append(self.DO3_real)
            self.line3_3.draw()
    #pH3
            comunicacion.initI2C(1, 0, 1)
            comunicacion.sendValueI2C([82])#114
            time.sleep(0.6)
            self.pH_real3=comunicacion.readValueI2C()
            self.ax4_3.set_xlabel('$x$'),self.ax4_3.set_ylabel('$y(x)$')
            #self.ax4_3.clear()
            print('pH3', self.pH_real3)
            self.ax4_3.set_ylim([0, 20]) # care here
            
            self.ax4_3.plot(self.x4_3,self.y4_3), self.ax4_3.grid(True)
            self.x4_3.append(datetime.now())
            self.y4_3.append(self.pH_real3)
            self.line4_3.draw()
